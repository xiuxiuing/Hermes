...
public class InstanceGettingReceiver extends Receiver {
    ...
    public void setMethod(MethodWrapper methodWrapper, ParameterWrapper[] parameterWrappers) throws HermesException {
        ...
        if (!Modifier.isStatic(method.getModifiers())) {
            throw new HermesException(ErrorCodes.METHOD_GET_INSTANCE_NOT_STATIC, "Method " + method.getName() + " of class " + mObjectClass.getName()
                    + " is not static. " + "Only the static method can be invoked to get an instance.");
        }
    ...
    protected Object invokeMethod() throws HermesException {
        ...
        throw new HermesException(ErrorCodes.METHOD_INVOCATION_EXCEPTION,
                "Error occurs when invoking method " + mMethod + " to get an instance of " + mObjectClass.getName(), exception);
    }
}
